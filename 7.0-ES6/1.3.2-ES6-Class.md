...
class Father {
    ...
    constructor(house, age, money) {
        ...
        this.sayHi = function () {
            ...
            console.log('sayHi', `${this.house}, ${this.age}, ${this.money}`);
        };
    }
}
...
class Person extends Father {
    ...
    constructor(house, age, money) {
        ...
        // 直接调用
        super(house, age, money);   // 若有继承关系，则需要在创建继承关系的 constructor 的 第一行调用一次 super
                                    // super(); 中也可以添加 Persnal 中自己独有的属性
                                    // 理论上: 建立父子继承连接

        // 作为对象使用
        super().sayHi();            // 调用父类中的方法
    }
}
