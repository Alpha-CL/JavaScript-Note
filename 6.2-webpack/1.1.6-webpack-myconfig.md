...
touch ./src/index.js;
touch ./src/assets/js/serverconfig.js;
...
npm install --save-dev webpack-bundle-analyzer                      // 交互式可缩放树图可视化webpack输出文件的大小
...
echo 'import {moduleHot} from "./assets/js/serverconfig.js";
